...
| S2 | Triggers DML: `:OLD`, `:NEW`, reglas automáticas de negocio y auditoría básica. | `BOM_CATALOGO` | Triggers `:OLD`/`:NEW`, reglas automáticas de negocio y auditoría básica. |
